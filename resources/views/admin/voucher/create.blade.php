	    ...
	    <section class="content">
	      	...
	      	<div class="box">
	        	<div class="box-header with-border">
        	 	...
        	 	<form onsubmit="return saveVoucher(this)" action="{{route($modulePath.'.store')}}" >
        	 		@csrf
	              	<div class="box-body">
	              		<div class="row">
	              			<div class="col-md-12">
				                <div class="form-group col-md-12">
				                  	...
				                  	<input type="text" placeholder="Enter Voucher code" name="voucher_code" id="voucher_code" class="form-control" >
				                  	<span class="help-block err_site_title"></span>
				                </div>
				                <div class="form-group col-md-12">
				                  	<label for="user_count">User Count  <span style="color: red">*</span></label>
				                  	<input type="text" placeholder="Enter User Count" name="user_count" id="user_count" class="form-control" >
				                  	<span class="help-block err_site_title"></span>
				                </div>
				                <div class="form-group col-md-12">
				                ...
				                <div class="form-group">
		              			...
		              			<div class="form-group">
			              			<div class="col-md-6">
					                  	...
					                  	<input type="text" placeholder="Select Start Date" name="start_date" id="start_date" class="form-control datepicker" >
					                  	<span class="help-block err_start_date"></span>
					                </div>

					                <div class="col-md-6">
					                  	<label for="end_date">End Date <span style="color: red">*</span></label>
					                  	<input type="text" placeholder="Select End Date" name="end_date" id="end_date" class="form-control datepicker" >
