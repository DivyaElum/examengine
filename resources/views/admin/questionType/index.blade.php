	      	...
	      	<div class="box">
	        	<div class="box-header with-border">
		          	...
		          	<div class="box-tools pull-right">
		          		<a title="Add New" href="{{ route($modulePath.'.create') }}" class="btn btn-social btn-linkedin" ><i class="fa fa-plus"></i>{{'Add New Question Type'}}</a>
		          	</div>
	        	</div>
...
@section('scripts')
	...
	<script type="text/javascript" src="{{ asset('js/admin/questionType/index.js') }}"></script>
@stop