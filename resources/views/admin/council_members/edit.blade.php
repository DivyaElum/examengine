				                  	...
				                  	<select onchange="getStructure(this)" class="form-control" name="type" >
				                  		...
				                  		@if(!empty($types) && count($types) > 0)
				                  			@foreach($types as $key => $type)
				                  				<option value="{{ $type->type }}" @if($object->question_type == $type->type ) selected @endif>{{ $type->title }}</option>
				                  			@endforeach
				                  		@endif
				                  	</select>
				                </div>
	                  		...
	                  		<div class="html_data">
		              			...
		              			<div class="true_false">
			              			...
			              			<div class="col-md-11">
					                  	<div class="input-group">
					                        <span class="input-group-addon">
					                          <input type="radio" name="correct" @if($object->correct_answer == 'b') checked @endif value="b" >
					                        </span>
