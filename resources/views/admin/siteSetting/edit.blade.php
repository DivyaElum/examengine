	    ...
	    <section class="content">
	      	<div class="box">
	        	<div class="box-header with-border">
        	 	...
        	 	<form onsubmit="return saveSiteSetting(this)" action="{{route($modulePath.'.update', [ base64_encode(base64_encode($objectData->id)) ])}}"  method="post" enctype="multipart/form-data">
	              		...
	              		<div class="row">
	              			<div class="col-md-12">
				                <div class="form-group">
				                  	...
				                  	<input type="text" placeholder="Enter Site Title" name="site_title" id="site_title" class="form-control" value="{{$objectData->site_title}}" >
				                ...
				                <div class="form-group">
				                  	...
				                  	<input type="text" placeholder="Enter Contact Number" name="contact_no" id="contact_no" class="form-control"  value="{{$objectData->contact_no}}" >
				                  	<span class="help-block err_txtValue"></span>
				                </div>
				                <div class="form-group">
				                  	<label for="email_id">Email Id <span style="color: red">*</span></label>
				                  	<input type="email" placeholder="Enter Email Id" name="email_id" id="email_id" class="form-control"  value="{{$objectData->email_id}}" >
				                  	<span class="help-block err_txtValue"></span>
				                </div>
				                <div class="form-group">
				                  	<label for="meta_keywords">Meta Keywords</label>
				                  	<input type="text" placeholder="Enter Meta Keywords" name="meta_keywords" id="meta_keywords" class="form-control"  value="{{$objectData->meta_keywords}}" >
				                  	<span class="help-block err_txtValue"></span>
				                </div>
				                <div class="form-group">
				                  	<label for="meta_desc">Meta Descriptions </label>
				                  	<textarea name="meta_desc" placeholder="Enter Meta Descriptions" id="meta_desc" class="form-control">{{$objectData->meta_desc}}</textarea>
				                  	<span class="help-block err_txtValue"></span>
				                </div>
				                <div class="form-group">
				                  	<label for="footer_text">Footer Text</label>
				                  	<input type="text" placeholder="Enter Footer Text" name="footer_text" id="footer_text" class="form-control"  value="{{$objectData->footer_text}}" >
				                  	<span class="help-block err_txtValue"></span>
				                </div>
				                <div class="form-group">
				                  	@php
              							if(!empty($objectData->site_logo))
              							{
              								$urlPath = url('/storage/'.$objectData->site_logo);
              							}
              							else
              							{
